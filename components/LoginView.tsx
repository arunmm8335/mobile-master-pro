...
export const LoginView: React.FC<LoginViewProps> = ({ onLoginSuccess, onNavigateRegister }) => {
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-700 p-8">
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            ...
            <button onClick={onNavigateRegister} className="text-slate-900 dark:text-white font-bold hover:underline">
              Register
            </button>
          </p>
        </div>
